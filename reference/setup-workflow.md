...
4. When asking for methodologies, present IDs 1 to 13 from `reference/methodology-map.md` as selectable choices, and explicitly add a choice "0. All Methodologies" at the top. Do NOT invent or present any other choices. 
